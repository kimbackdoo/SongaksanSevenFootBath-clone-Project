...
#GalleryUl > li { float:left; width:288px; margin:0 0 20px 4%; position:relative; text-align:center }
#GalleryUl > li:nth-child(2n+1) { margin-left:0%; }
#GalleryUl > li > a { display:inline-block; text-decoration:none; width:100%; }
.slide_icon { position:absolute; top:20px; left:20px; z-index:1; }
.GU_thumb { width:100%; height:288px; object-fit:cover; display:block; float:left; }
