...
.board_list th { font-weight:400; font-size:17px;border-top:1px solid #dddddd;border-bottom:1px solid #dddddd;background:#f8f8f8 }
...
.search_select { 
	width:120px; height:36px; border:1px solid #d8d8d8; position:relative; float:left; font-size:16px; padding-left:15px; background:#f9f9f9; outline:none; box-sizing:border-box; color:#5d5d5d; font-weight:400; 
	-webkit-appearance:none; -moz-appearance:none; appearance:none; 
	background:url('/img/select_arrow.jpg') no-repeat right 15px top 15px;
}
select.search_select::-ms-expand { display:none; }

.search_box { float:left; display:inline; border:1px solid #d8d8d8; margin-left:5px; }
.board_search #search_input > #stx { border:0; width:170px; height:34px; margin:0; padding:0 0 0 10px; letter-spacing:0px; color:#5d5d5d; font-size:16px; font-weight:400; }
.board_search #search_input { float:left; }
.board_search #search_submit { float:right; height:34px; }
.board_search #search_submit input { padding:10px; }
</style>
<!--게시판 서치부분-->
