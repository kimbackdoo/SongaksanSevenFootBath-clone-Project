...
<style>
.swiper-m4 { width: 100%; max-width: 1560px; height: 405px; position: relative; float: right; padding-top: 45px; }
.swiper-m4 .swiper-slide { width:405px; height:100%; position:relative; margin:0 auto; }
.swiper-slide > a > img:last-child { transition: .2s; }
.swiper-slide:hover > a img:last-child { box-shadow: 5px 10px 10px 0px rgba(0,0,0,0.5); transform:scale(0.925); }
...
<script>
	...
	$(function(){
		swiper_gallery = new Swiper('.swiper-m4', {
						spaceBetween: 50,
						centeredSlides: true,
						autoplay: {
							delay: 4000,
