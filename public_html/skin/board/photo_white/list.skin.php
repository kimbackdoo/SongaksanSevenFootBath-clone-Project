...
#GalleryUl > li { float:left; width:375px; height: 375px; margin:0 0 60px 37px; position:relative; }
#GalleryUl > li:nth-child(3n+1) { margin-left:0; }
#GalleryUl > li > a { display:inline-block; text-decoration:none; width:100%; height: 100%; }
.GU_thumb { width:100%; height:100%; object-fit:cover; display:block; float:left; }
.gallery_icon { position: absolute; top: 20px; left: 20px; z-index: 3; }
	...
	<ul id="GalleryUl" >
		...
		?>
			...
			<li class="wow fadeInUp" data-wow-delay="0.3s">
				<a href="<?=$list[$i]["href"]?>" >
					<img src="/res/images/m4/icon.png" alt="아이콘" class="gallery_icon" />
